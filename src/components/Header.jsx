        ...
        <header className="w-full pt-8 md:pt-32 min-[1440px]:pt-52 sm:py-4 text-center overflow-hidden md:bg-[url('/img/INICIO2.webp')] bg-right bg-cover bg-no-repeat bg-[#97D700] md:bg-transparent min-[1180px]:pb-20 min-[2140px]:pb-32 min-[2270px]:pb-72">
            <div className="relative md:flex w-full md:w-6/12">
                ...
                <div className="mb-8 md:mb-6 sm:mb-4 md:ml-5 min-[950px]:ml-14 min-[1950px]:ml-32">
                    <h1 className=" italic text-4xl md:text-2xl min-[650px]:text-5xl min-[900px]:text-3xl lg:text-4xl xl:text-5xl min-[1440px]:text-5xl min-[1700px]:text-6xl min-[1950px]:text-7xl font-eastman-black text-[#001A70]">
                        ¡Aprender inglés <span className="text-white block  font-eastman">es soñar sin fronteras!</span>
                    </h1>
                ...
                <div className="relative block md:hidden">
                    ...
                    <div className="bg-white pt-4 min-[650px]:pt-10 -mt-28 min-[490px]:-mt-32 min-[650px]:-mt-40 md:-mt-6 sm:-mt-4 pb-20 block md:hidden">
                        <h2 className="text-2xl md:text-3xl sm:text-2xl text-[#001A70] m-0 drop-shadow-lg tracking-wide font-eastman-black pt-20">
                            Año Escolar <span className="font-lemon-bold">2025-2026</span>
                        </h2>
                    </div>
                </div>
            </div>
