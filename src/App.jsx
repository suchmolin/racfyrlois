...
function App() {
  return (
    <div id="inicio" className="min-h-screen overflow-hidden font-eastman">
      <Navbar />
      <Header />
      <HeroSection />
      <FeaturesSection />
      <SomosUnaEmpresa />
      <FeaturesGrid />
      <h2 id="etapas" className='text-3xl sm:text-4xl lg:text-6xl xl:text-7xl min-[1960px]:text-8xl text-[#001A70] text-center font-black leading-7 pt-20 sm:pt-28 lg:pt-44 min-[1700px]:pt-64'>¡Una formación <br /> continua de alto nivel!</h2>

      <div className="flex justify-center w-full">
        <h2 className='text-white bg-[#001A70] text-base min-[375px]:text-xl sm:text-3xl lg:text-4xl xl:text-5xl min-[1960px]:text-6xl py-1 lg:py-4 xl:py-8 px-3 lg:px-8 rounded-lg lg:rounded-2xl text-center font-bold mt-5 w-fit xl:leading-[50px]'>
      ...
      <div className="w-full flex flex-col items-center bg-white pt-10 relative -mt-52 pb-[270px] min-[400px]:pb-[350px] min-[540px]:pb-[450px] min-[650px]:pb-[550px]  min-[800px]:pb-[650px] min-[935px]:pb-[750px] min-[1065px]:pb-[850px] min-[1185px]:pb-[950px] min-[1300px]:pb-[1050px] min-[1460px]:pb-[1150px] min-[1590px]:pb-[1250px] min-[1720px]:pb-[1350px] min-[1850px]:pb-[1450px]  min-[1980px]:pb-[1550px]">
        <div className="w-fit relative ">
          ...
          <h3 className="text-xl min-[375px]:text-2xl min-[650px]:text-4xl min-[800px]:text-5xl min-[1185px]:text-6xl min-[1460px]:text-7xl bg-[#001A70] p-4 md:p-8 text-white text-center rounded-lg relative font-bold text-nowrap z-10 leading-7">
