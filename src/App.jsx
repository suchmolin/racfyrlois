...
function App() {
  return (
    <div id="inicio" className="eastman min-h-screen overflow-hidden font-eastman">
      <Navbar />
      <Header />
      <HeroSection />
      <FeaturesSection />
      <SomosUnaEmpresa />
      <FeaturesGrid />
      <h2 id="etapas" className='text-3xl sm:text-4xl lg:text-6xl xl:text-7xl min-[1960px]:text-8xl text-[#001A70] text-center font-eastman-black leading-7 pt-20 sm:pt-28 lg:pt-44 min-[1700px]:pt-64'>¡Una formación <br /> continua de alto nivel!</h2>

      <div className="flex justify-center w-full">
        <h2 className='w-[340px] min-[375px]:w-[360px] sm:w-[630px] lg:w-[850px] xl:w-[1080px] min-[1960px]:w-[1500px] text-white bg-[#001A70] text-sm min-[375px]:text-base sm:text-3xl lg:text-4xl xl:text-5xl min-[1960px]:text-6xl py-1 lg:py-4 xl:py-8 px-2 lg:px-8 rounded-lg lg:rounded-2xl text-center font-eastman-bold mt-5 xl:leading-[50px]'>
          Guiamos a tu hijo en su formación en inglés,
